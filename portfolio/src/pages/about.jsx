    ...
    <div className="bg-sky-200 grid place-items-center">
      ...
      <div className="flex flex-col pt-8 md:pt-20 h-full min-h-screen w-11/12 md:w-180 lg:w-256 xl:w-300">
        ...
        <img
          ...
          className="self-center object-cover mt-5 mb-12 md:mt-6 md:mb-16 lg:mt-8 lg:mb-24 h-60 w-60
        ...
        <h2 className="w-full my-6 lg:my-8
          text-center font-super-carnival text-transparent text-6xl lg:text-7xl
          text-stroke-color-[#333] text-stroke-width-[2px] lg:text-stroke-width-[3px]
          text-shadow-[3px_3px_#6acbf8] lg:text-shadow-[4px_4px_#6acbf8]"
        >
          My Resume
        </h2>
        <TimeLine />
